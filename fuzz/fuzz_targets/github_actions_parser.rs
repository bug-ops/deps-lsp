...
static WORKFLOW_URI: LazyLock<Url> = LazyLock::new(|| {
    Url::from_file_path("/fuzz/.github/workflows/ci.yml").expect("static fixture path")
});
static ACTION_URI: LazyLock<Url> =
    LazyLock::new(|| Url::from_file_path("/fuzz/action.yml").expect("static fixture path"));
