...
- **deps-nuget**: harden `compile_requirement`/`format_version_replacing` against an unexpanded MSBuild property reference (`Version="$(SomeProperty)"`) being treated as a satisfiable requirement (see #1347)
