...
### Changed
- **deps-core**: consolidated `github`/`deps_dev`/`osv`'s near-identical bounded-`DashMap` eviction policies and duplicated `CACHE_EVICTION_PERCENTAGE` constant into a shared `cache_policy` module (resolves #977)
