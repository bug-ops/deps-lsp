...
### Fixed
- **deps-core**: `Diagnostic::new`/`RelatedInformation::new` now sanitize `message` as a defense-in-depth backstop on the constructor path, on top of existing producer-side sanitization (resolves #1276) (PR link pending)
