...
- **deps-lsp**: fetch-failure toast no longer implies every counted package produced a "Registry lookup failed" diagnostic, since the count also includes not-found lookups, which surface as "Unknown package" instead (resolves #490)
