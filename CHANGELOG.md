...
- **deps-core, deps-engine, and all 14 ecosystem crates**: package/module names are now redacted before reaching logs, error messages, or LSP client-visible diagnostics, closing a workspace-wide credential-shaped-name leak in the fetch/classify path and its error types (resolves #1209)
