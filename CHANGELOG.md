...
### Fixed
- **deps-nuget**: an ancestor directory's `packages.lock.json` no longer shadows a nested project's own `packages.<Project>.lock.json` one directory closer (resolves #1351)
