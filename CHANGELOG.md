...
### Fixed
- **deps-core**: Gradle/Maven version-completion's same-line fallback no longer resolves the wrong dependency when multiple dependencies share one manifest line (resolves #1146)
