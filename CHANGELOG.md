...
### Fixed
- **deps-github-actions**: SHA-pinned `uses:` refs with a partial `# vX`/`# vX.Y` comment tag now get inlay hints/diagnostics, using the registry-confirmed tag over the comment when available (resolves #907) (#TBD)
