...
### Fixed
- **deps-core, deps-gitlab-ci, deps-lsp**: `IndexUrlError::InvalidUrl`'s payload is now a `RedactedUrl`, closing credential-log paths (tracing and `window/showMessage`) via a hostile `registries.gitlab_instance_host` value (resolves #808)
