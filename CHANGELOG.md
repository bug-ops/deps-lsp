...
- **fuzz**: new `bundler_lockfile`, `go_lockfile`, `toml_lockfiles` (Cargo/PyPI), `json_lockfiles` (npm/Composer/NuGet/Swift), and `deps_cli_config` targets close the lock-file/config-parser fuzz-coverage gap (resolves #1404)
