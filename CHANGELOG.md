...
- **deps-core, deps-nuget**: a NuGet.Config source rejected for a non-blocked-host reason (invalid URL, non-https, userinfo, unresolvable/encrypted credential, unset %VAR%) now surfaces a warning diagnostic (resolves #1442)
