...
- **deps-bundler, deps-dart**: gems behind a Gemfile `source ... do` block or inline `source:` option, and `hosted:` pubspec dependencies, are now classified as a custom registry instead of being queried against rubygems.org/pub.dev (resolves #980)
