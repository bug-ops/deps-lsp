...
- **deps-bundler, deps-core**: closed residual private-source-leak vectors in malformed-Gemfile parsing without regressing legitimate multi-line/parenthesized `gem(...)` calls (resolves #1039)
