...
### Fixed
- **deps-dart**: aliasing a whole dependency section or `environment:` mapping via a YAML anchor now resolves correctly instead of silently losing its data (resolves #905)
