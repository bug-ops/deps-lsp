...
- **deps-gradle**: fixed a total version-completion regression from #922 — compact GAV coordinates and version catalog entries returned zero completions because their detected range was never wired to the literal's real byte span (resolves #931) (#TBD)
