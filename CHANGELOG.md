...
- **deps-gradle**: Groovy DSL's eight dependency-pattern matchers consolidated into one shared extraction helper, fixing a latent dedup-bookkeeping gap that skipped `matched_positions` tracking in two of them (resolves #533)
