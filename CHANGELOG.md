...
### Fixed
- **deps-core**: `#[redact(key)]` fields generated by `RedactingDebug` no longer force a `String` allocation on every `Debug` format call, restoring the `Cow`-based no-alloc path for the common no-redaction-needed case (resolves #1333)
