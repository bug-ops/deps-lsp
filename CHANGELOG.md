...
### Fixed
- **deps-dart**: fixed unbounded `O(N x document length)` scans in the pubspec.yaml parser by rewriting position tracking onto `yaml-rust2`'s event API (resolves #899) (#TBD)
