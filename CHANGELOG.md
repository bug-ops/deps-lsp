...
- **deps-swift, deps-gitlab-ci, deps-core, deps-bundler, deps-pypi, deps-npm**: closes the remaining CWE-532 Debug-leak sites with manual, redacting `Debug` impls, backed by a new shared conformance macro (resolves #1222) (#1222)
