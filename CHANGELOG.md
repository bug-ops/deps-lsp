...
- **deps-core**: new `lsp_helpers::HoverMarkdown` typed builder replaces `generate_hover`'s bare `&mut String` accumulator, structurally enforcing per-field-kind length caps and escaping instead of relying on call-site discipline (resolves #1310)
