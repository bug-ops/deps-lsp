...
- **deps-gitlab-ci**: a Tag-shaped ref with an embedded, non-leading variable reference (e.g. `v16.0-$BUILD`) no longer reports permanently `Outdated`; it's now correctly classified `Unresolved` (part of #1370)
