...
- **deps-core, deps-github-actions, deps-gitlab-ci, deps-dart, deps-npm**: new `deps_core::check_yaml_bounds` helper centralizes duplicated YAML nesting-depth/expansion-guard wiring across 5 call sites (resolves #1245)
