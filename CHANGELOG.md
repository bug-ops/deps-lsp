...
- **deps-maven, deps-gradle**: `format_version_replacing` no longer rewrites an unresolved `${property}`/`$var` placeholder to a literal version, including malformed-range shapes (resolves #1353)
