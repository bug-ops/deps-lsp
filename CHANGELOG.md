...
- **deps-bundler**: hash-rocket `:group =>`, `:require =>`, and `:platforms =>` per-gem options are now recognized, closing the remaining #987 gap left by #989's four other options (resolves #990)
