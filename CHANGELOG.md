...
- **deps-github-actions**: `action.yml`/`action.yaml` composite/Docker/JS action manifests (a repository root or `.github/actions/<name>/`) now get the same hover, diagnostics, SHA-pin quick fix, and code lens as workflow files (resolves #706)
