...
- **deps-core, deps-deno, deps-lsp**: folded the tier-3 license-fetch capability signal into `LicenseSource` (`requires_dedicated_fetch()`), added `FetchedDeclaredSpdx` for Deno (resolves #697)
