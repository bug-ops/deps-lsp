...
### Fixed
- **deps-maven, deps-nuget**: a malformed XML tag whose name is credential-shaped no longer leaks the credential into `quick_xml` parse-error log/stderr output (resolves #1243)
