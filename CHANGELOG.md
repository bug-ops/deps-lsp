...
- **deps-github-actions, deps-core**: fixed a quadratic-time parsing regression on single-line manifests with many ref-pinned GitHub Actions dependencies (resolves #885) (#TBD)
