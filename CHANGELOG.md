...
### Changed
- **Breaking (public API)**: **deps-core**: `deps_core::policy_config`'s 7 structs are now `#[non_exhaustive]`, with `new()`/`with_*` constructors added where missing (resolves #1064)
