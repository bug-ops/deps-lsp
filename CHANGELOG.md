...
- **deps-gitlab-ci, deps-core, deps-lsp**: new GitLab CI/CD ecosystem — `include: - project:`+`ref:` and `include: - component:` CI/CD Catalog pins resolved against the GitLab repository-tags/project-releases APIs, self-hosted instances via `registries.gitlab_instance_host`, `GITLAB_TOKEN` support (resolves #466)
