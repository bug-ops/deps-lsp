...
### Fixed
- **deps-maven, deps-gradle**: fix deps-gradle license fetch and deps-maven's Google-group routing to resolve androidx/Firebase POMs via Google Maven instead of 404ing against Maven Central (#1479)
