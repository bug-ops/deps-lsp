...
### Fixed
- **deps-cargo**: unknown-package completion tests now run against a mocked crates.io sparse index instead of the live registry, so a network outage or a real zero-request regression no longer passes vacuously (resolves #1045)
