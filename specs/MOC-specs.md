...
| 065 | [[065-cli-check-symlink-manifest-walk/spec\|deps-cli Symlink Manifest Walk: warn-only detection + opt-in --follow-symlinks]] | tasks | bug/security, P1 (issue #1112, same fail-open class as #1109/#1108, closed by #1111) |
