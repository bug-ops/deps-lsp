...
| 034 | [[034-go-goproxy-private-registry/spec\|Go GOPROXY/GOPRIVATE module proxy resolution]] | specify | draft — research/enhancement, P3, ready for implementation, no open `[NEEDS CLARIFICATION]` items (issue #519) |
