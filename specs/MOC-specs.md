...
| 066 | [[066-canonical-document-identity/spec\|Canonical document identity: canonicalize URIs once at server entry instead of per-handler URI rekeying]] | tasks | enhancement, P4, tasks ready (issue #1086) |
