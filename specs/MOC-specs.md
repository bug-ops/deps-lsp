...
| 062 | [[062-cli-check-mode/spec\|CLI check mode: deps-cli non-LSP diagnostics (table/json/sarif, pre-commit, GitHub Action)]] | tasks | draft — research/enhancement, P3, 21 tasks across 3 PRs ready for implementation via `/rust-team`, tracked in issue #711 |
