...
| 064 | [[064-deps-cli-lsp-isolation/spec\|deps-cli tower-lsp-server isolation: protocol-agnostic diagnostics domain type]] | tasks | in review — PR #1101 open (branch feat/1083-deps-cli-lsp-isolation), implementation expanded beyond original plan (tower-lsp-server gated across all 14 ecosystem crates, not 3, plus `generate_completions`), plan.md/tasks.md updated to match, resolves #1083 |
