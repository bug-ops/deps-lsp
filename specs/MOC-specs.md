...
|----|---------|-------|--------|
| 071 | [[071-typosquat-similarity-diagnostic/spec\|Typosquat detection via deps.dev's GetSimilarlyNamedPackages endpoint]] | specify | draft — research/parity, P2 (reassessed from P3: Snyk/Socket.dev both have typosquatting detection, see competitive-parity.md), 6 open `[NEEDS CLARIFICATION]` items |
