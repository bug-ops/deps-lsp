...
| 037 | [[037-supply-chain-trust-signal/spec\|Supply-chain trust signal (OpenSSF Scorecard + SLSA provenance) via deps.dev]] | plan | draft — research/parity, P3, plan complete pending critic review (issue #543) |
