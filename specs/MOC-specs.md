...
| 030 | [[030-gitlab-ci-ecosystem/spec\|New ecosystem: GitLab CI/CD include: version pins]] | plan | draft — research/new ecosystem, P4, 0 open `[NEEDS CLARIFICATION]` items; implemented in `crates/deps-gitlab-ci`, PR open for issue #466 — mark shipped once merged |
