...
| 010 | [[010-license-hover-policy/spec\|License in hover + license-policy diagnostics]] | plan | planned — research/parity, P4, issue #204, plan complete (1 task-level clarification: Swift/Gradle/Deno source verification deferred to implementation per Registry Integration Gate) |
