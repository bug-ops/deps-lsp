...
| 064 | [[064-deps-cli-lsp-isolation/spec\|deps-cli tower-lsp-server isolation: protocol-agnostic diagnostics domain type]] | tasks | draft — enhancement, P4, 0 open `[NEEDS CLARIFICATION]` items, 10 tasks ready, continues spec 063's descoped FR-005 (issue #1083) |
