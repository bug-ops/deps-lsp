...
- **Release-freshness signal (partial)** (issue #486) — `GithubActionsRegistry::
  ...
  versions with a matching GitHub Release (see the [deps-lsp book](https://bug-ops.github.io/deps-lsp/ecosystems/github-actions.html#release-freshness-coverage-shared-with-swift))
