...
/// Fuzz-only entry point for [`parse_package_resolved`] (issue #1404). Gated on the
...
#[cfg(feature = "fuzzing")]
#[doc(hidden)]
pub fn fuzz_parse_package_resolved(content: String) {
    let _ = parse_package_resolved(content);
}
