...
/// ```
// Exhaustive, not `#[non_exhaustive]`: 25+ existing struct-literal sites across `deps-npm`,
// `deps-composer`, and `deps-lsp` already build this by field, not worth migrating for a
// two-field type (issue #755).
