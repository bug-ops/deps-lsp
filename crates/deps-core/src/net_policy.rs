...
/// rounds converged on.
///
/// Also fixed, in the same round as this doc's own update:
...
///
/// Four narrow, low-severity gaps remain from round 7's adversarial sweep and the #875 report,
...
/// description above as bounded by these four documented, tracked exceptions, not as a
